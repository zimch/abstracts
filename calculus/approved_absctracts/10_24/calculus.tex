...
\begin{document}
    ...
    \begin{proof}
        ...
        $\overset{\text{лемма}}{\implies} \lim_{l \to \infty} \int_{\widetilde{E_l} \cap E_k}f = \int_{E_k} f \le \lim_{l\to\infty} \int_{\widetilde{E_l}} f$ % propustil implies \lim k \int E_k f \le \lim l \int E_l f
