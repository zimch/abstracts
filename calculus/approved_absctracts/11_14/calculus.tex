...
\begin{document}
    ...
    \begin{proof}
        ...
        \par $\Rightarrow \frac{\partial f}{\partial y} (x, y + \xi(n)) - \frac{\partial f}{\partial y}(x, y) \rightrightarrows_{h \rightarrow 0}^{x \in [a, b] } 0$ %%вот тут гавно какоита
        ...
        \]
        \[
            \underbrace{\frac{1}{h} \int_a^b (f(x, y+h) - f(x, y)) dx}_{\xrightarrow[h \rightarrow 0]{} \frac{d}{dx}\int_a^b f(x, y) dx} = \underbrace{\int_a^b \frac{f(x, y + h) - f(x, y)}{h} dx}_{\rightrightarrows_{h \rightarrow 0}{} \frac{\partial f}{\partial y}(x, y)} % x \in [a, b]   
        \] %
    \end{proof}
