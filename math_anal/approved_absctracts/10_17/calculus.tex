...
\begin{document}
    ...
    \begin{theorem}
        ...
        \par Тогда
        \[
            \exists \rhimani{G} f \circ g |\det g'| = \rhimani{g(G)} % ДОМНОЖЕННОЕ??    
        \]
    \end{theorem}

    \begin{lemma} % тут нужно \bar сделать длинными%
    ...
    \begin{proof}
        ...
        \par Переход \quad $(g(x))_i = x_i , \quad i \ge k+1 \quad x = (y, z)$ % y, z - vectors (photo)
        \par $ $
